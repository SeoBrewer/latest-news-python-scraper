...
def scrape_elpais():
    ...
    print(f"Found {len(articles)} articles on El Pais")

    # Crear un conjunto de enlaces ya guardados
    saved_links = set()

    try:
        with open("elpais_news.csv", "r", newline="", encoding="utf-8") as csvfile:
    ...
    with open("elpais_news.csv", "a", newline="", encoding="utf-8") as csvfile:
